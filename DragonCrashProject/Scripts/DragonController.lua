...
function dragoncontroller:HandleMovementTick(deltaTime)
	-- TODO: This will need to be updated to use the physics component sender instead. Otherwise collisions won't work.
	...
	translation = translation + forwardDirection * self.Properties.FlightSpeed * deltaTime;
	...
	-- apply transform
	self.transformSender:SetWorldTM(transform);
end
