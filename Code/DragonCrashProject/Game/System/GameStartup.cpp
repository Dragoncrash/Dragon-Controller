...
#include "Core/DragonCrashProjectGame.h"
...
{
    static char gameBuffer[sizeof(LYGame::DragonCrashProjectGame)];

    ISystem* system = m_Framework->GetISystem();
    ModuleInitISystem(system, "DragonCrashProject");

    m_Game = new(reinterpret_cast<void*>(gameBuffer)) LYGame::DragonCrashProjectGame();
