...
#include "DragonCrashProjectGame.h"
#include "IGameFramework.h"
#include "IGameRulesSystem.h"
#include "DragonCrashProjectGameRules.h"
...
DragonCrashProjectGame* LYGame::g_Game = nullptr;

//////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////

DragonCrashProjectGame::DragonCrashProjectGame()
...
bool DragonCrashProjectGame::Init(IGameFramework* framework)
{
    ...
    REGISTER_FACTORY(framework, "DragonCrashProjectGameRules", DragonCrashProjectGameRules, false);
    IGameRulesSystem* pGameRulesSystem = g_Game->GetIGameFramework()->GetIGameRulesSystem();
    pGameRulesSystem->RegisterGameRules("DummyRules", "DragonCrashProjectGameRules");
...
bool DragonCrashProjectGame::CompleteInit()
{
    return true;
}

int DragonCrashProjectGame::Update(bool hasFocus, unsigned int updateFlags)
{
...
void DragonCrashProjectGame::PlayerIdSet(EntityId playerId)
{
    m_clientEntityId = playerId;
}

void DragonCrashProjectGame::Shutdown()
{
    this->~DragonCrashProjectGame();
}

void DragonCrashProjectGame::LoadActionMaps(const char* fileName)
{
...
void DragonCrashProjectGame::ReleaseActionMaps()
{
...
bool DragonCrashProjectGame::ReadProfile(const XmlNodeRef& rootNode)
{
...
bool DragonCrashProjectGame::ReadProfilePlatform(const XmlNodeRef& platformsNode, LYGame::Platform platformId)
{
    bool successful = false;
    ...
    if (platformsNode && (platformId > ePlatform_Unknown) && (platformId < ePlatform_Count))
    {
        ...
        {
            GameWarning("DragonCrashProjectGame::ReadProfilePlatform: Failed to find platform, action mappings loading will fail");
        }
    }
...
LYGame::Platform DragonCrashProjectGame::GetPlatform() const
{
...
void DragonCrashProjectGame::OnActionEvent(const SActionEvent& event)
{
