...
namespace LYGame
{
    DECLARE_DEFAULT_COMPONENT_FACTORY(DragonCrashProjectGameRules, IGameRules)

    bool DragonCrashProjectGameRules::Init(IGameObject* pGameObject)
    {
    ...
    void DragonCrashProjectGameRules::PostInit(IGameObject* pGameObject)
    {
    ...
    DragonCrashProjectGameRules::~DragonCrashProjectGameRules()
    {
    ...
    bool DragonCrashProjectGameRules::OnClientConnect(ChannelId channelId, bool isReset)
    {
